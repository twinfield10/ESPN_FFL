...
| 18 | [Season usage model](18-season-usage-model.md) | **High (seasonal)** | M | The pre-season / draft head. Scoped M rather than L because the measured season-level case is modest — expected PPG is *more stable* than actual PPG (+0.816 vs +0.792) but not more accurate (+0.779 vs +0.792) |
